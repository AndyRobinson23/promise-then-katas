...
const returnPromise = () => {
    return new Promise((resolve) => resolve('The promise resolved successfully'))
};
...
const returnTen = () => { return new Promise((resolve) => resolve(10)) };
...
const returnString = () => { return new Promise((resolve) => resolve('string')) };
...
const returnBob = () => { return new Promise((resolve) => resolve({ name: 'Bob' })) };
...
const returnList = () => { return new Promise((resolve) => resolve(['eggs', 'apples', 'milk', 'bread'])) };
...
const anError = () => { return new Promise((resolve, reject) => reject('An error occurred')) };

// 7 Create a function that returns a promise which returns 666 if it rejects
// Example:
// theNumberOfTheBeast() rejects to the value 666

const theNumberOfTheBeast = () => { return new Promise((resolve, reject) => reject(666)) };
...
const internalServerError = () => { return new Promise((resolve, reject) => reject({ error: 500 })) };
...
const myNameIs = () => {
    return new Promise((resolve, reject) => {
        resolve(function myNameIs(name) {
